...
namespace PassWalletAPI.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        [HttpPost]
        public Task<Users> Login([FromBody] LoginUsersDto loginUser) //Kullanıcı girişi
        {
            var userFromDb = _loginRepository.Login(loginUser);
            if (userFromDb == null)
                return null;
            return userFromDb;
        }
        ...
        [HttpGet("{email}")]
        public Task<string> EncryptEmail(string email) //Kullanıcı girişi
        {
            var userFromDb = _loginRepository.EncryptEmail(email);
            return userFromDb;
        }
